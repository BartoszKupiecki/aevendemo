      ...
      <header className="App-header">
        ...
        >
          <g class="aeven-logo-full">
            ...
            <path
              class="aeven-logo-2"
              d="M49.65 19.415h22.557c0-6.185-4.275-10.278-10.915-10.278-6.549 0-10.551 3.547-11.643 10.278m-10.824 4.457C38.825 9.772 48.012.04 61.2.04c13.462 0 22.012 9.005 22.012 23.012v3.366l-33.837.091c.819 7.913 5.003 11.915 12.37 11.915 6.095 0 10.097-2.364 11.37-6.64h10.28c-1.91 9.824-10.097 15.736-21.832 15.736-13.37 0-22.74-9.732-22.74-23.65"
            ></path>
            <path
              class="aeven-logo-3"
              d="M110.301 1.405l-12.37 31.179L85.56 1.405H74.645l17.828 44.934h10.915l17.829-44.934z"
            ></path>
            <path
              class="aeven-logo-4"
              d="M122.86 19.415h22.558c0-6.185-4.275-10.278-10.915-10.278-6.549 0-10.551 3.547-11.643 10.278m-10.824 4.457c0-14.1 9.187-23.831 22.376-23.831 13.462 0 22.012 9.005 22.012 23.012v3.366l-33.837.091c.819 7.913 5.003 11.915 12.37 11.915 6.096 0 10.097-2.364 11.371-6.64h10.278c-1.91 9.824-10.096 15.736-21.83 15.736-13.371 0-22.74-9.732-22.74-23.65"
            ></path>
            <path
              class="aeven-logo-5"
              d="M153.204 46.339V1.405h10.278l.91 5.821c2.82-4.548 8.277-7.185 14.372-7.185 11.279 0 17.1 7.003 17.1 18.646V46.34h-11.097V21.325c0-7.55-3.73-11.188-9.46-11.188-6.822 0-11.006 4.73-11.006 12.007v24.195h-11.097z"
            ></path>
          </g>
        </svg>
        <p style={{ color: "#cd5c4e" }}> Enterprise CMP Platform</p>
      </header>
    </div>
  );
}
